...
import { useArticlesByCategory } from "@/hooks/use-public";
...
export default function CategoryPage() {
      ...
      <div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-10">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
            <p className="text-red-600">Bantuan tidak ditemukan.</p>
            <Link
              href="/"
  ...
  return (
    <div>
      <Breadcrumb
        items={[{ label: category.name, href: `/bantuan/${category.slug}` }]}
      />
      <div className="max-w-6xl mx-auto px-4 py-10">
        {/* <Link
          href="/"
